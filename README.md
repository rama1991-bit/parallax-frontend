...
- Phase 2 ingested-article analysis, article-id compare, event-cluster-aware compare context, node-based article detail, bounded OSINT panels, default source seeding, active source sync controls, source/topic intelligence aggregation panels, topic detail event cluster panels, intelligence refresh/run controls, cluster refresh/run controls, intelligence feed cards, ingestion health badges, source quality badges, source operational alerts, alert delivery status/actions, provider metadata badges, and admin source/feed governance controls
...
6. After deploy, test onboarding, feed, admin-gated default source seeding and active source sync in `/sources`, source health and quality badges, source intelligence refresh, batch intelligence refresh/run history, cluster refresh/run history, topic intelligence snapshots in `/topics`, topic detail pages and event clusters in `/topics/<id>`, generated intelligence feed cards, source operational alert evaluation/delivery/acknowledgement, source review controls, feed pause/quarantine/reactivate controls, recent sync runs, ingested-article analyze, `/articles/<id>` node tabs and OSINT panel provider badges, article-id compare provider badge, alerts, sources, reports, saved reports, compare, and briefs in one browser session.
