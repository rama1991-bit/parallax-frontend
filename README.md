...
- Phase 2 ingested-article analysis, article-id compare, node-based article detail, bounded OSINT panels, default source seeding, active source sync controls, ingestion health badges, source quality badges, source operational alerts, alert delivery status/actions, and admin source/feed governance controls
